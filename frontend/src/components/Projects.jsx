				...
				<div className="projects-list">
					<ul>
						<li>
							...
							<p>
								An AI chatbot is implemented to the site with Google Gemini. It is
								located at bottom right of this page. You can ask it any question
								and it will try to answer it. It is not perfect, but it is a good
								example of how AI can be used in web development. Remember to not
						...
						<h3>
							...
							<p>
								...
								to the leaderboard database. I wanted to try to add a simple game
								that uses the database from the backend to store scores. Try to
								reach the #1 spot! Original source code is from{' '}
								<a
								...
								The game is modified to use Redux for state management and to save
